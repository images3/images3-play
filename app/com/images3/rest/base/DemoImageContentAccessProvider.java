...
public class DemoImageContentAccessProvider {
    
    private Properties config;
        
    public DemoImageContentAccessProvider(String pathToConfig) {
        this(readConfigProperties(pathToConfig));
    }
    
    public DemoImageContentAccessProvider(Properties config) {
        this.config = config;
    }
    ...
    public ImageContentAccess getImageContentAccess() {
        ...
        return new DemoImageContentAccessImpl(dir);
    }
}
